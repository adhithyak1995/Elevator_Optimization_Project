	...
	for(i=1;i<=200;i++)
	{
		...
		*/
		...
		{	
			...
			printf("\nElevator is %d",j);	
			printf("\nCurrent Time is %d",em[j].current_time);	
...
//		for(k=0;k<no_of_lift;k++)
//		{
//			if(em[k].move_up == true && em[k].move_down == false && em[k].take_in == false )
//			{
//			
//					fprintf(sch,"%d\t%d\t%d\tmoving up\n",i,(k+1),em[k].floor);
//				}
//			else if(em[k].move_up == false && em[k].move_down == true && em[k].take_in == false)
//			{
//				fprintf(sch,"%d\t%d\t%d\tmoving down\n",i,(k+1),em[k].floor);
//			}
//			else if(em[k].take_in == true)
//			{
//				fprintf(sch,"%d\t%d\t%d\tpicking-up %d\n",i,(k+1),em[k].floor);
//			}
//		}	
